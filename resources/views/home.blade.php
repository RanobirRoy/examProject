...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{url('assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}"
    />
              ...
              >
                ...
                <a class="dropdown-item">
                  <div class="item-thumbnail">
                    <img
                      src="{{url('assets/images/faces/face4.jpg')}}"
                      alt="image"
                      class="profile-pic"
                    />
                  </div>
                ...
                <a class="dropdown-item">
                  <div class="item-thumbnail">
                    <img
                      src="{{url('assets/images/faces/face2.jpg')}}"
                      alt="image"
                      class="profile-pic"
                    />
                  </div>
                ...
                <a class="dropdown-item">
                  <div class="item-thumbnail">
                    <img
                      src="{{url('assets/images/faces/face3.jpg')}}"
                      alt="image"
                      class="profile-pic"
                    />
                  </div>
